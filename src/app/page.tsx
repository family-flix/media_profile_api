    ...
    <main className="flex min-h-screen flex-col p-24">
      <div>
            ...
            <div>
              <Button
                onClick={async () => {
                  ...
                  const { platform, name, poster_path, seasons } = json.data;
                  setValues((prev) => {
                    return {
                      ...prev,
                      name,
        ...
        {(() => {
          ...
          const { name, poster_path, seasons } = values;
          return (
            <div className="profile">
              {/* <div className="flex">
                <div className="mr-4">
                  <img className="w-[240px]" src={poster_path} alt={name} />
                </div>
                <div>
              ...
              <div className="flex flex-wrap gap-3 mt-8">
                {seasons.map((season) => {
                  const { name, poster_path, overview, air_date, episodes } = season;
                  return (
                    <div
                      key={name}
                      className="w-[120px]"
                    ...
                    >
                      <div className="relative w-full h-[160px] bg-gray-200">
                        {poster_path ? <img className="w-full" src={poster_path} alt={name} /> : null}
